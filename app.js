...
app.post('/api/signup', async (req, res) => {
    ...
    try {
        ...
        const result = await pool.query(query, [name, username, email, password]);
        ...
        if (error.code === '23505') { // PostgreSQL unique_violation error code for duplicate usernames or emails
